...
public class AdditionServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String resultMessage = "<div style='text-align: center; padding: 20px; background-color: #3498DB; color: #ECF0F1; border-radius: 10px;width:50%'>";
            resultMessage += "<h3>Addition Result:</h3>";
